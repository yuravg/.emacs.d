...
(use-package bm
  ...
  (progn
    ...
    (defhydra hydra-bm (:color red
                        :hint nil
                        :body-pre (when (not (use-region-p)) (push-mark)))
      "
Bookmarks
  _n_ext (_N_ in lifo order)         toggle book_m_ark     ^^_/_ bm lines matching regexp                       _t_oggle persistence                    List: _s_et, _j_ump, _l_ist
